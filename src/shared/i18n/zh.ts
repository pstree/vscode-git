export default {
    ...
    'toolbar.searchPlaceholder': '过滤：提交说明 / 哈希',
    'toolbar.authorPlaceholder': '过滤：作者',
    'toolbar.authorTitle': '按作者过滤提交（可从已有作者中选择）',
    'toolbar.filesChanged': '改动文件',
    'toolbar.closeFiles': '关闭改动文件面板',
    'toolbar.closeFilesAria': '关闭改动文件面板',
    ...
    'toolbar.projectChip': '项目',
    'toolbar.projectChipClear': '显示全部项目',
    'toolbar.projectChipClearAria': '清除项目过滤',
